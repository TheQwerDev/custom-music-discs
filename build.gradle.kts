...
loom {
    ...
    accessWidenerPath = file("src/main/resources/custommusicdiscs.classtweaker")
}
repositories {
    mavenCentral()
...
dependencies {
    ...
    implementation(libs.clientJar) // implementation required for paulscode.sound.SoundSystem
